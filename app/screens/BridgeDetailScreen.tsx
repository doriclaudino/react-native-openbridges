                        ...
                        <FlatList
                            ...
                            renderItem={({ item }) => <View><Divider />
                                <List.Item
                                    ...
                                    onPress={() => { }}
                                    left={() => (<TouchableRipple onPress={() => { }}><List.Icon color="gray" icon="schedule" /></TouchableRipple >)}
                                    right={item.when ? () => (<TouchableRipple onPress={() => { this._handleDeleteEvent(bridge, item) }}><List.Icon color="gray" icon="delete" /></TouchableRipple >) : undefined}
                                /></View>}
                        />
                    </Card.Content>
                </Card>
